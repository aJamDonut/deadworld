(function () {
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.helper_job_point = {
    "sprite": 'btn_blank_sqr',
    "meta": {
      "physicsType": 'logic',
      "weight": 0
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.pers_auto_button = {
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.pers_auto_output = {
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.pers_auto_rotatepad = {
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.pers_auto_switch = {
    "sprite": 'sprite_auto_switch_on',
    "meta": {
      "physicsType": 'logic',
      "weight": 0
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.sensor_npc_area = {
    "sprite": 'btn_blank_sqr2',
    "meta": {
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.pers_auto_scales = {
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.pers_auto_clonepod = {
    "sprite": 'w_emptyclonepod',
    "meta": {
      "physicsType": 'sensor',
      "weight": 0
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.pers_door_wooden = {
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.spawner_template = {
    "sprite": 'btn_blank_sqr',
    "meta": {
      "weight": 0
    },
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.spawn_basic_shopkeeper = {
    "sprite": 'btn_blank_sqr',
    "meta": {},
    "events": {
      "onCreate": function (spawner) {
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.spawn_slinky = {
    "sprite": 'btn_blank_sqr',
    "meta": {},
    "events": {
      "onCreate": function (spawner) {
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.spawn_jess = {
    "sprite": 'btn_blank_sqr',
    "meta": {},
    "events": {
      "onCreate": function (spawner) {
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.spawn_bigdog = {
    "sprite": 'btn_blank_sqr',
    "meta": {},
    "events": {
      "onCreate": function (spawner) {
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.spawn_world_script = {
    "sprite": 'btn_blank_sqr',
    "meta": {},
    "events": {
      "onCreate": function (spawner) {
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.spawn_gremblo = {
    "sprite": 'btn_blank_sqr',
    "meta": {
      "weight": 0
    },
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.spawn_gremblo_packed = {
    "sprite": 'btn_blank_sqr',
    "meta": {
      "weight": 0
    },
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.spawn_dag = {
    "sprite": 'btn_blank_sqr',
    "meta": {},
    "events": {
      "onCreate": function (spawner) {
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.spawn_redeye = {
    "sprite": 'btn_blank_sqr',
    "meta": {},
    "events": {
      "onCreate": function (spawner) {
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.spawn_wolfen = {
    "sprite": 'btn_blank_sqr',
    "meta": {},
    "events": {
      "onCreate": function (spawner) {
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.spawn_dag_baby = {
    "sprite": 'btn_blank_sqr',
    "meta": {},
    "events": {
      "onCreate": function (spawner) {
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.spawn_horse1 = {
    "sprite": 'btn_blank_sqr',
    "meta": {
      "weight": 0
    },
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.spawn_horse2 = {
    "sprite": 'btn_blank_sqr',
    "meta": {
      "weight": 0
    },
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.spawn_horse3 = {
    "sprite": 'btn_blank_sqr',
    "meta": {
      "weight": 0
    },
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.vehicle_1xplatform = {
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.pers_worlditem_1xplatform = {
    "sprite": 'sprite_stonebench',
    "meta": {
      "blockZone": 'all',
      "collisionGroups": 'all',
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.pers_worlditem_kitchen = {
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.pers_worlditem_printer = {
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.pers_worlditem_loadingbench = {
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.pers_worlditem_fabricator = {
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.pers_worlditem_glasskiln = {
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.pers_worlditem_advancedforge = {
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.ws_when_done = {
    "meta": {},
    "events": {
      "onCreate": function () {}
    },
  ...
  _BLUEPRINTS.COMPLEX_ITEMS.testooooo = {
    "meta": {},
    "events": {},
    "parent": 'build_world_scripts',
    "name": 'testoooo'
  };
  _BLUEPRINTS.COMPLEX_ITEMS.worldscript_testo = {
    "sprite": 'btn_blank_sqr',
    "meta": {},
    "events": {},
    "parent": 'build_world_scripts',
