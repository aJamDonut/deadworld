...
/*!
 * pixi-projection - v0.4.4
 * Compiled Mon, 10 Jan 2022 19:51:04 UTC
 *
...
(function (global, factory) {
	...
	this,
	function (exports, core, constants, utils, math, display, spriteTiling, mesh, meshExtras, sprite, text, graphics) {
		"use strict";

		const shaderVert$2 = `precision highp float;
...
gl_FragColor = color * vColor;
		...
		exports.TRANSFORM_STEP = void 0;
		(function (TRANSFORM_STEP) {
			const NONE = 0;
			TRANSFORM_STEP[(TRANSFORM_STEP["NONE"] = NONE)] = "NONE";
			// POS = 1,
			// ROT = 2,
			// SCALE = 3,
			// PIVOT = 4,
			const BEFORE_PROJ = 4;
			TRANSFORM_STEP[(TRANSFORM_STEP["BEFORE_PROJ"] = BEFORE_PROJ)] = "BEFORE_PROJ";
			const PROJ = 5;
			TRANSFORM_STEP[(TRANSFORM_STEP["PROJ"] = PROJ)] = "PROJ";
			// POS_2 = 6,
			// ROT_2 = 7,
			// SCALE_2 = 8,
			// PIVOT_2 = 9,
			const ALL = 9;
			TRANSFORM_STEP[(TRANSFORM_STEP["ALL"] = ALL)] = "ALL";
		})(exports.TRANSFORM_STEP || (exports.TRANSFORM_STEP = {}));

		exports.AFFINE = void 0;
		(function (AFFINE) {
			const NONE = 0;
			AFFINE[(AFFINE["NONE"] = NONE)] = "NONE";
			const FREE = 1;
			AFFINE[(AFFINE["FREE"] = FREE)] = "FREE";
			const AXIS_X = 2;
			AFFINE[(AFFINE["AXIS_X"] = AXIS_X)] = "AXIS_X";
			const AXIS_Y = 3;
			AFFINE[(AFFINE["AXIS_Y"] = AXIS_Y)] = "AXIS_Y";
			const POINT = 4;
			AFFINE[(AFFINE["POINT"] = POINT)] = "POINT";
			const AXIS_XR = 5;
			AFFINE[(AFFINE["AXIS_XR"] = AXIS_XR)] = "AXIS_XR";
		...
		class LinearProjection extends AbstractProjection {
			constructor(...args) {
				super(...args);
				LinearProjection.prototype.__init.call(this);
				LinearProjection.prototype.__init2.call(this);
				LinearProjection.prototype.__init3.call(this);
				LinearProjection.prototype.__init4.call(this);
				LinearProjection.prototype.__init5.call(this);
			}
			// eslint-disable-next-line @typescript-eslint/no-unused-vars
			updateLocalTransform(lt) // eslint-disable-next-line @typescript-eslint/no-empty-function
			{}
			...
			__init3() {
				this._affine = exports.AFFINE.NONE;
			}
			__init4() {
		...
		class UniformBatchRenderer extends core.AbstractBatchRenderer {
			constructor(...args) {
				super(...args);
				UniformBatchRenderer.prototype.__init.call(this);
				UniformBatchRenderer.prototype.__init2.call(this);
			}
		...
		function getPositionFromQuad(p, anchor, out) {
			...
			const a1 = 1.0 - anchor.x;
			const a2 = 1.0 - a1;
			const b1 = 1.0 - anchor.y;
			const b2 = 1.0 - b1;
		...
		Matrix2d.__initStatic();
		Matrix2d.__initStatic2();

		const shaderVert$1 = `attribute vec2 aVertexPosition;
attribute vec2 aTextureCoord;
...
`;
		...
		class TilingSprite2dRenderer extends core.ObjectRenderer {
			constructor(renderer) {
				super(renderer);
				TilingSprite2dRenderer.prototype.__init.call(this);
			...
			render(ts) {
				...
				shader.uniforms.uColor = utils.premultiplyTintToRgba(
					ts.tint,
					ts.worldAlpha,
					shader.uniforms.uColor,
					baseTex.premultiplyAlpha
				);
		...
		class Projection2d extends LinearProjection {
			constructor(legacy, enable) {
				super(legacy, enable);
				Projection2d.prototype.__init.call(this);
				Projection2d.prototype.__init2.call(this);
				Projection2d.prototype.__init3.call(this);
		...
		class Container2d extends display.Container {
			...
			toLocal(position, from, point, skipUpdate, step = exports.TRANSFORM_STEP.ALL) {
				if (from) {
...
gl_FragColor = texture2D(uSampler, vTextureCoord) * uColor;
			...
			constructor(geometry, shader, state, drawMode) {
				...
				Mesh2d.prototype.__init.call(this);
				this.proj = new Projection2d(this.transform);
			}
			...
			calculateVertices() {
				...
				if (
					geometry.vertexDirtyId === thisAny.vertexDirty &&
		...
		Mesh2d.__initStatic();
		Mesh2d.__initStatic2();

		class SimpleMesh2d extends Mesh2d {
			constructor(texture, vertices, uvs, indices, drawMode) {
				super(
					new mesh.MeshGeometry(vertices, uvs, indices),
				...
				SimpleMesh2d.prototype.__init2.call(this);
		...
		class Sprite2d extends sprite.Sprite {
			constructor(texture) {
				super(texture);
				Sprite2d.prototype.__init.call(this);
				this.proj = new Projection2d(this.transform);
		...
		meshExtras.SimpleMesh.prototype.convertTo2d = meshExtras.SimpleRope.prototype.convertTo2d =
		...
		class Text2d extends text.Text {
			constructor(text, style, canvas) {
				...
				Text2d.prototype.__init.call(this);
				this.proj = new Projection2d(this.transform);
				this.pluginName = "batch2d";
			}
...
`;
		...
		class SpriteMaskFilter2d extends core.Filter {
			constructor(sprite) {
				...
				SpriteMaskFilter2d.prototype.__init.call(this);
			...
			apply(filterManager, input, output, clearMode) {
				...
				this.uniforms.otherMatrix = SpriteMaskFilter2d.calculateSpriteMatrix(
					input,
					this.maskMatrix,
					maskSprite
			...
			static calculateSpriteMatrix(input, mappedMatrix, sprite) {
				...
				const worldTransform =
					proj && !proj._affine
						? proj.world.copyTo2dOr3d(tempMat$2)
						: tempMat$2.copyFrom(sprite.transform.worldTransform);
		...
		class ObservablePoint3d extends math.ObservablePoint {
			constructor(...args) {
				super(...args);
				ObservablePoint3d.prototype.__init.call(this);
			}
			__init() {
				this._z = 0;
			}
		...
		class Euler {
			constructor(x, y, z) {
				Euler.prototype.__init.call(this);
				Euler.prototype.__init2.call(this);
				Euler.prototype.__init3.call(this);
				/**
				 * @member {number}
				 * @default 0
				 */
		...
		class ObservableEuler {
			...
			constructor(cb, scope, x, y, z) {
				this.cb = cb;
				this.scope = scope;
				ObservableEuler.prototype.__init.call(this);
				ObservableEuler.prototype.__init2.call(this);
				ObservableEuler.prototype.__init3.call(this);
				/**
				 * @member {number}
				 * @default 0
				 */
		...
		class Matrix3d {
			...
			constructor(backingArray) {
				Matrix3d.prototype.__init.call(this);
				Matrix3d.prototype.__init2.call(this);
				Matrix3d.prototype.__init3.call(this);
				Matrix3d.prototype.__init4.call(this);
				Matrix3d.prototype.__init5.call(this);
		...
		Matrix3d.__initStatic();
		Matrix3d.__initStatic2();
		...
		class Projection3d extends LinearProjection {
			constructor(legacy, enable) {
				super(legacy, enable);
				Projection3d.prototype.__init.call(this);
				Projection3d.prototype.__init2.call(this);
				Projection3d.prototype.__init3.call(this);
				Projection3d.prototype.__init4.call(this);
				Projection3d.prototype.__init5.call(this);
				Projection3d.prototype.__init6.call(this);
			...
			updateLocalTransform(lt) {
				...
				if (!this.cameraMode) {
					matrix.setToRotationTranslationScale(
						euler.quaternion,
						pos._x,
						pos._y,
						pos._z,
		...
		class Camera3d extends Container3d {
			constructor() {
				super();
				Camera3d.prototype.__init.call(this);
				Camera3d.prototype.__init2.call(this);
				Camera3d.prototype.__init3.call(this);
				Camera3d.prototype.__init4.call(this);
		...
		class Mesh3d2d extends mesh.Mesh {
			constructor(geometry, shader, state, drawMode) {
				super(geometry, shader, state, drawMode);
				Mesh3d2d.prototype.__init.call(this);
				this.proj = new Projection3d(this.transform);
			}
		...
		class SimpleMesh3d2d extends Mesh3d2d {
			constructor(texture, vertices, uvs, indices, drawMode) {
				...
				SimpleMesh3d2d.prototype.__init2.call(this);
		...
		class Sprite3d extends sprite.Sprite {
			constructor(texture) {
				super(texture);
				Sprite3d.prototype.__init.call(this);
				Sprite3d.prototype.__init2.call(this);
				Sprite3d.prototype.__init3.call(this);
				this.proj = new Projection3d(this.transform);
				this.pluginName = "batch2d";
			}
		...
		meshExtras.SimpleMesh.prototype.convertTo3d = meshExtras.SimpleRope.prototype.convertTo3d =
		...
		class Text3d extends text.Text {
			constructor(text, style, canvas) {
				super(text, style, canvas);
				Text3d.prototype.__init.call(this);
				this.proj = new Projection3d(this.transform);
				this.pluginName = "batch2d";
			}
...
gl_FragColor = color * rColor;
		...
		class BatchBilinearPluginFactory {
			...
			static create(options) {
				...
				return (
					(_class = class BatchPlugin extends UniformBatchRenderer {
						constructor(renderer) {
							super(renderer);
		...
		class Surface {
			constructor() {
				Surface.prototype.__init.call(this);
				Surface.prototype.__init2.call(this);
				Surface.prototype.__init3.call(this);
				Surface.prototype.__init4.call(this);
			}
			__init() {
			...
			// eslint-disable-next-line @typescript-eslint/no-unused-vars
			fillUniforms(uniforms) // eslint-disable-next-line @typescript-eslint/no-empty-function
			{}
		...
		class BilinearSurface extends Surface {
			constructor(...args) {
				super(...args);
				BilinearSurface.prototype.__init.call(this);
			}
			__init() {
				this.distortion = new math.Point();
			}
			...
			applyInverse(pos, newPos) {
				...
				const vx = pos.x;
				const vy = pos.y;
				const dx = this.distortion.x;
				const dy = this.distortion.y;
		...
		class ProjectionSurface extends AbstractProjection {
			constructor(...args) {
				super(...args);
				ProjectionSurface.prototype.__init.call(this);
				ProjectionSurface.prototype.__init2.call(this);
				ProjectionSurface.prototype.__init3.call(this);
				ProjectionSurface.prototype.__init4.call(this);
				ProjectionSurface.prototype.__init5.call(this);
			}
			__init() {
				this._surface = null;
			}
			...
			get uniforms() {
				if (
					this._currentLegacyID === this.legacy._worldID &&
		...
		class Sprite2s extends sprite.Sprite {
			constructor(texture) {
				super(texture);
				Sprite2s.prototype.__init.call(this);
		...
		class Text2s extends text.Text {
			constructor(text, style, canvas) {
				super(text, style, canvas);
				Text2s.prototype.__init.call(this);
				this.proj = new ProjectionSurface(this.transform);
				this.pluginName = "batch_bilinear";
			}
...
if (typeof pixi_projection !== "undefined") {
	Object.assign(this.PIXI.projection, pixi_projection);
}
